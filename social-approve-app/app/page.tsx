      ...
      <main className="max-w-7xl mx-auto px-6 py-6 space-y-8">
        ...
        <section>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            {/* Content Library */}
            <Link
              href={primaryBrand ? `/social/${primaryBrand.slug.toUpperCase()}/content-library` : '/social'}
              className="group bg-slate-800/50 backdrop-blur-sm rounded-lg p-4 border border-slate-700/50 hover:border-purple-500/50 hover:bg-slate-800/70 transition-all"
            >
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <h3 className="text-white font-medium text-sm">Content Library</h3>
                  <p className="text-xs text-slate-500 truncate">Images & videos</p>
                </div>
              </div>
            </Link>
          </div>
