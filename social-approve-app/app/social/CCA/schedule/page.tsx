      ...
      <header className="bg-slate-900 border-b border-slate-700 sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-6 py-3">
          <div className="flex items-center justify-between gap-4">
            ...
            {/* Center: Connected Accounts */}
            {brand?.oneup_category_id && (
              <div className="flex items-center gap-2 flex-1 justify-center">
                <span className="text-slate-500 text-xs">Publishing to:</span>
                {loadingAccounts ? (
                  ...
                  <div className="flex items-center gap-1.5">
                    {connectedAccounts.map((account) => (
                      ...
                      >
                        ...
                        <span>{account.social_network_name}</span>
                      </div>
                    ))}
                  </div>
                ) : (
                  <span className="text-slate-500 text-xs">No accounts</span>
                )}
              </div>
            )}
